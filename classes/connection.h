...
public:
  ...
  double post_pre_STDP_scale;                            // = -stdp_scale; // how fast do synaptic strength change (negative, rarely used)  //TODO this value must be found later and tune
  double pre_post_STDP_scale;                            // = stdp_scale; // how fast do synaptic strength change (positive, commonly used)  //TODO this value must be found later and tune
