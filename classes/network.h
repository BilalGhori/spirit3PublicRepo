...
static const int layers = 3;                      //number of layers and z(+1!) of output layer at the same time
                                                  //  static const int layer_size[4]={input_size,middle_ex_size,middle_in_size,output_size}; //TODO fix this and moove it to class
static const int layer_size[layers] = {7, 28, 9}; //TODO fix this and moove it to class
