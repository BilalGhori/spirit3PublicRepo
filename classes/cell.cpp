...
{
    //TODO remove the ex column from both read and written files
...
Cell::Cell()
{
    ...
    u = -2.821443297088526; //second demintional state variable
    u_temp = -2.8214;       //second demintional state variable
